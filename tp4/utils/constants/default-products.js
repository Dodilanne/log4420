module.exports = [
    ...
    },
    {
        ...
        category: "cameras",
        description:
            "Le Nikon D7000 est un appareil photographique reflex numérique, présenté par Nikon le 15 septembre 2010. Il remplace le D90 comme reflex de milieu de gamme. (<a href='https://fr.wikipedia.org/wiki/Nikon_D7000' target='_blank'>Wikipédia</a>)",
        features: [
    ...
    },
    {
        ...
        category: "computers",
        description:
            "Portable idéal pour un étudiant ou un joueur occasionnel. L'ordinateur dispose de plusieurs ports (HDMI, USB, Ethernet, etc.) pouvant accueillir plusieurs périphériques. Le portable est équipé d'un processus i5 de troisième génération, de 8 Go de mémoire et d'un disque dur SSD de 256 Go. De plus, ce portable est équipé d'une carte graphique NVIDIA GeForce GTX 660M.",
        features: [
    ...
    },
    {
        ...
        category: "screens",
        description:
            "Moniteur LCD de 19 pouces pouvant être branché via VGA, HDMI et DVI. Cet écran est facilement ajustable dans plusieurs positions, afin de maximiser le confort de l’utilisateur.",
        features: [
            'Écran de 19"',
    ...
    },
    {
        ...
        category: "screens",
        description:
            'Téléviseur de 50" possédant une résolution de 1080p. Ce téléviseur est parfait pour visionner vos séries préférées. De plus, cette télévision possède trois prises HDMI et un support natif pour la technologie <em>Chromecast</em>.',
        features: [
    ...
    },
    {
        ...
        category: "consoles",
        description:
            "La Wii est une console de jeux vidéo de salon du fabricant japonais Nintendo. Console de la septième génération, tout comme la Xbox 360 et la PlayStation 3 avec lesquelles elle est en rivalité, elle est la console de salon la plus vendue de sa génération et a comme particularité d'utiliser un accéléromètre capable de détecter la position, l'orientation et les mouvements dans l'espace de la manette. (<a href='https://fr.wikipedia.org/wiki/Wii' target='_blank'>Wikipédia</a>)",
        features: [
    ...
    },
    {
        ...
        category: "consoles",
        description:
            "Manette pouvant être branchée à une console Xbox 360 et un PC. Cette manette vous permettra de jouer à vos jeux vidéo préférés. De plus, cette manette est sans fil et comporte un port pour casque d'écoute.",
        features: [
